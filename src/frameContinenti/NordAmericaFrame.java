 ...
 */
public class NordAmericaFrame extends JFrame {
     private BufferedImage immagine;
     private JFrame parentFrame;
     private FileRandomNationNordAmerica fileRandomNation = new FileRandomNationNordAmerica();
    private FileRandomNationNordAmerica.Nation randomNation = null;
    ...
    public NordAmericaFrame(JFrame parentFrame) {
        this.parentFrame = parentFrame;
        setTitle("America del nord");
        setSize(800, 600);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setExtendedState(JFrame.MAXIMIZED_BOTH);
        setLocationRelativeTo(null);

        immagine = FunzioniFrame.caricaImmagine("src/images/nordamerica.png");
