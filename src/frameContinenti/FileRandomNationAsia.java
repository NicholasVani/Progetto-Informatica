 ...
 */
class FileRandomNationAsia {
    public String imageFolder = "src/images/flagsAsia/";
    
    public Nation getRandomNation() throws IOException {
        File file = new File("src/file/asianation.txt");
        if (!file.exists()) {
            throw new IOException("Il file 'asianation.txt' non esiste.");
        }
