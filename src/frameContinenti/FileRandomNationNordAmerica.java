...
class FileRandomNationNordAmerica {
    public String imageFolder = "src/images/flagsNordAmerica/";
    
    public Nation getRandomNation() throws IOException {
        File file = new File("src/file/nordamericanation.txt");
        if (!file.exists()) {
            throw new IOException("Il file 'nordamericanation.txt' non esiste.");
        }
