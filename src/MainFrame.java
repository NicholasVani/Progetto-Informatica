    ...
    public MainFrame() {
        ...
        JPanel pannelloImmagine = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                drawHitbox(g2d, ContinentPolygons.getAmericaPolygon(), xScale, yScale); // America Sud
                drawHitbox(g2d, ContinentPolygons.getOceaniaPolygon(), xScale, yScale); // Oceania
                drawHitbox(g2d, ContinentPolygons.getAmericaNordPolygon(), xScale, yScale); // America Nord
            }
    ...
    private void openContinentFrame(String continent) {
        ...
        switch (continent) {
            ...
            case "America del nord":
                continentFrame = new NordAmericaFrame(this);
                break;
            case "Oceania":
